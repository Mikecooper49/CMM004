    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="OnArrival.php">On-Arrival</a></li>
    ...
    <div class="row content">
        ...
        <div class="col-sm-8 text-left">
            ...
            <p>
                ...
                area. Since the discovery of North Sea oil in the 1970s, Aberdeen has been known as the off-shore oil
                capital of Europe.The area around Aberdeen has been settled for at least 8,000 years when prehistoric
                villages lay around the mouths of the rivers Dee and Don. The city has a long, sandy coastline and a
                marine climate, the latter resulting in chilly summers and mild winters.
            </p>
            <hr>
            <div class="row">
