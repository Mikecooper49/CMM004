...
<main>
    <div align="center">
        <h1>Edit User Login Details </h1>
        <div style="width:600px; border:20px;  align:right">
            <div class="loginbox" align="center" style="margin:40px 40px">
                ...
                <input type="hidden" name="userID" value="<?php echo $userID; ?>">
                    ...
                    <div id="userEmail">
                        ...
                        <input type="password" name="passConfirm" id="passConfirm" placeholder="Confirm New Password">
